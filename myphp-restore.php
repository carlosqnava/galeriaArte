 ...
 */
if(isset($_POST)){
	// Recoger datos de respaldo.php para la variable del archivo a respaldar
	$archivoActual = $_POST['dirArchivoRestore'];
}
/**
...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'museoartedb');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'BACKUP_DIR'); // Comment this line to use same script's directory ('.')
//define("BACKUP_DIR", 'myphp-backup-files'); // Comment this line to use same script's directory ('.')

define("BACKUP_FILE", $archivoActual); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
