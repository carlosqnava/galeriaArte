            ...
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                <thead>
                  ...
                  <tbody>
                    <<?php foreach($this->modelo->getColpermanente() as $Colp): ?>
                    <tr>
                        <th scope="row"><?= $Colp->idobj?></th>
                        <td><?= $Colp->fechAdq?></td>
                        <td><?= $Colp->estado?></td>
                        <td><?= $Colp->costo?></td>
                        <td>
                          <a href="?c=objetoArte&a=FormAgregar&id=<?=$Colp->idobj?>" class="btn btn-info btn-flat">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Eliminar coleccion permanente..</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>Estas seguro de eliminar coleccion permanente?</p>
...
<script type="text/javascript">
  $(function(){
    ...
    $('#btneliminar').on('click', function(event){
      ...
      var url = "?c=colpermanente&a=Eliminar&id="+ idobj;
